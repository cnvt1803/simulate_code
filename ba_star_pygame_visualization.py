...
class PygameVisualizer:
    ...
    def draw_info_panel(self):
        ...
        for btn_data in self.buttons.values():
            ...
            btn_text = self.font_medium.render(btn_data['text'], True, text_color)
            text_rect = btn_text.get_rect(center=btn_rect_local.center)
            panel_surface.blit(btn_text, text_rect)
        
        # Legend
        legend_y = 350
        legend_title = self.font_medium.render("Legend:", True, self.colors['black'])
        ...
        controls_title = self.font_medium.render("Controls:", True, self.colors['black'])
